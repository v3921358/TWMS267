let EXIT_MAP = 272020110;

let PHASE_1 = 272020210;
let PHASE_2 = 272020310;
let PHASE_3 = 272020410;
...
function mobDied(mob) {
	switch (mob.getDataId()) {
		case 8860005:
			event.getMap(FIELD_1).blowWeather(5120026, "消滅了阿卡伊農，請通過臺階左側傳送空移動。", 10);
            event.getMap(FIELD_1).setReactorState("break1", 1);
			break;
