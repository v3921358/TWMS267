let EXIT_MAP = 811000999;
let PHASE_1 = 811000500;
...
function init(attachment) {
	...
	let boss1 = map_1.makeMob(9450066);
	boss1.changeBaseHp(200_000_000_000);
	event.getMap(PHASE_1).spawnMob(boss1, 360, -206);
