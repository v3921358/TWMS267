...
if (event != null && event.getVariable("phase1")  && event.getVariable("phase2")) {
        ...
        let goongi = map.makeMob(8880909);
        goongi.changeBaseHp(132_0000_0000_0000);
        map.spawnMob(goongi, -1598, 362);

        let dool = map.makeMob(8880910);
        dool.changeBaseHp(132_0000_0000_0000);
        map.spawnMob(dool, 402, 362)

        let hondon = map.makeMob(8880911);
        hondon.changeBaseHp(132_0000_0000_0000);
        map.spawnMob(hondon, -594, 362)


        let boss = map.makeMob(8880912);
        boss.changeBaseHp(132_0000_0000_0000);
        boss.setHpLimitPercent(0.75)
        map.spawnMob(boss, -243, 398)

        let ref = map.makeMob(8880913);
        ref.changeBaseHp(132_0000_0000_0000);
