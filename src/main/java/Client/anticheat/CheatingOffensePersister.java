...
import Net.server.Timer.CheatTimer;
    ...
    public class PersistingTask implements Runnable {
        ...
        public void run() {
            ...
            try (Connection con = DatabaseConnectionEx.getInstance().getConnection()) {
                PreparedStatement insertps = con.prepareStatement("INSERT INTO cheatlog (characterid, offense, count, lastoffensetime, param) VALUES (?, ?, ?, ?, ?)", DatabaseConnectionEx.RETURN_GENERATED_KEYS);
