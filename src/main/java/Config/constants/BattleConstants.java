...
public class BattleConstants {
    ...
    public static Point getNPCPos(int mapid) {
        switch (mapid) {
            case 925020010: //新手教學 - 武陵道場修煉場
            case 925020011: //新手教學 - 武陵道場修煉場
            case 925020012: //新手教學 - 武陵道場修煉場
            case 925020013: //新手教學 - 武陵道場修煉場
            case 925020014: //新手教學 - 武陵道場修煉場
                return new Point(252, 2);
            case 980010100: //納希沙漠競技場 - 第一次競技場&lt;等候室>
            case 980010200: //納希沙漠競技場 - 第二次競技場&lt;等候室>
            case 980010300: //納希沙漠競技場 - 第三次競技場&lt;等候室>
                return new Point(142, 91);
            case 980010020: //納希沙漠競技場 - 競技場出口
                return new Point(190, 205);
            case 980010000: //納希沙漠競技場 - 競技場等候室
    ...
    public static long getPokemonCustomHP(int mobId, long def) {
        switch (mobId) {
            ...
            case 8840005: //小城堡石頭人
            case 8600000: //變異的蝸大牛
            case 8600001: //變異的花蘑大菇
            case 8600002: //變異的綠水大靈
            case 8600003: //變異的漂漂大豬
            case 8600004: //變異的提大諾
            case 8600005: //變異的提大魯
            case 8600006: //變異的提古大爾
            case 8610000: //魂靈
            case 8610001: //火焰
            case 8610002: //風暴
            case 8610003: //黑暗
    ...
    public enum PokemonMap {
        ...
        MAP1(190000000, 1, 4, 2, new Point(20, 35), new Point(320, 35)), //premium路 - 呼吸寺院門口
        ...
        MAP5(191000001, 6, 4, 1, new Point(-90, -15), new Point(210, -30)), //premium路 - 樹木迷宮
        ...
        MAP8(195000000, 16, 4, 3, new Point(1500, 1294), new Point(1800, 1294)), //premium路 - 危險的螞蟻洞
        MAP9(195010000, 16, 4, 2, new Point(300, 1659), new Point(0, 1659), true), //premium路 - 獨眼獸洞穴
        MAP10(195020000, 16, 4, 1, new Point(70, -31), new Point(370, -31)), //premium路 - 暗黑洞穴
        MAP11(195030000, 16, 4, 1, new Point(-200, 160), new Point(100, 160)), //premium路 - 怪貓打獵場
        MAP12(196000000, 21, 4, 5, new Point(-700, -26), new Point(-400, -26)), //維多利亞 - 荒涼的山丘
        MAP13(196010000, 21, 4, 1, new Point(100, 454), new Point(400, 454)), //維多利亞 - 荒涼的山崖
        MAP14(197000000, 26, 4, 0, new Point(250, 132), new Point(550, 132)), //玩具城 - 暴風露台Ⅰ
        MAP15(197010000, 26, 4, 2, new Point(-600, -78), new Point(-300, -78)), //玩具城 - 暴風露台Ⅱ
        MAP16(600010000, 31, 4, 5, new Point(-950, -1307), new Point(-650, -1307)), //新葉城-邊陲地帶 - 城市地下
        MAP17(880000000, 36, 4, 4, new Point(-1300, 215), new Point(-1000, 215)), // - 
        MAP18(881000000, 41, 4, 3, new Point(1500, -173), new Point(1800, -173)), //- 死靈集海岸
        MAP19(809020000, 46, 4, 0, new Point(400, 338), new Point(700, 338)), //隱道 - 兜
        MAP21(922220000, 51, 4, 0, new Point(0, 153), new Point(300, 153)), //隱藏地圖 - 陰暗森林
        MAP22(924000100, 56, 4, 0, new Point(-400, 422), new Point(-100, 422)), //神木村 - 天巢的頂端
        MAP23(925010300, 61, 4, 0, new Point(-533, 333), new Point(-233, 333)), //隱藏地圖 - 守護紅粉天書！
        MAP24(950000100, 66, 4, 0, new Point(1300, 275), new Point(1600, 275)), //秘密地圖 - 導遊妮妮森林
        MAP25(970020001, 71, 4, 0, new Point(300, 155), new Point(600, 155)), //隱藏地圖 - 諾特勒斯近海
        MAP26(970020002, 76, 4, 0, new Point(-300, 543), new Point(0, 543)), //隱藏地圖 - 武陵雲海
        MAP27(970020003, 81, 4, 0, new Point(-50, 181), new Point(250, 181)), //隱藏地圖 - 百草堂渡口
        MAP28(970020004, 86, 4, 0, new Point(-500, -18), new Point(-200, -18)), //隱藏地圖 - 瑪加提亞地下水道
        //970020005 - 隱藏地圖 - 水下世界渡船
        MAP29(910300000, 91, 4, 0, new Point(-100, -2131), new Point(200, -2131)), //廢棄都市 - 達克魯的訓練場
        MAP32(910210000, 96, 4, 0, new Point(700, 165), new Point(1000, 165)), //隱藏地圖 - 聖瑞尼亞城城門
        MAP33(910500000, 101, 9, 2, new Point(0, 130), new Point(300, 130)), //黑森林 - 異界弓箭手修煉場
        MAP34(910500100, 111, 9, 0, new Point(-700, -200), new Point(-400, -200)), //黑森林 - 秘密的神殿
        MAP35(910500200, 121, 9, 1, new Point(-100, -1130), new Point(200, -1130)), //黑森林 - 遺忘的聖殿
    ...
    public enum PokemonMob {
        ...
        //沒有Andras(PokemonItem.Courage_Piece, MobExp.FAST, PokemonAbility.PurePower, PokemonAbility.SheerForce, 150000, 150001, 150002, 9400609, 9400591),
        //sprout(1), morning glory(3), grape juice(5), amdusias(25), rellik(120)
        //沒有Amdusias(PokemonItem.Accuracy_Piece, MobExp.FAST, PokemonAbility.PurePower, PokemonAbility.SheerForce, 150000, 150001, 150002, 9400610, 9400592),
        //sprout(1), morning glory(3), grape juice(5), crocell(25), heron(120)
        //沒有Crocell(PokemonItem.Freedom_Piece, MobExp.FAST, PokemonAbility.PurePower, PokemonAbility.SheerForce, 150000, 150001, 150002, 9400611, 9400589),
        //sprout(1), morning glory(3), grape juice(5), marbas(25), margana(120)
        //沒有Marbas(PokemonItem.Wisdom_Piece, MobExp.FAST, PokemonAbility.PurePower, PokemonAbility.SheerForce, 150000, 150001, 150002, 9400612, 9400590),
        //sprout(1), morning glory(3), grape juice(5), valefor(25), hsalf(120)
        //沒有Valefor(PokemonItem.Dexterity_Piece, MobExp.FAST, PokemonAbility.PurePower, PokemonAbility.SheerForce, 150000, 150001, 150002, 9400613, 9400593),
        ...
        //沒有Blue_Snake(PokemonItem.Water_Bottle, MobExp.STANDARD, PokemonAbility.Intimidate, PokemonAbility.PoisonTouch, 1150002, 2130103, 9420002, 2100105, 4230503, 9420516, 9300293),
        ...
        //沒有Lupin(PokemonItem.Minidungeon_Crystal, MobExp.STANDARD, PokemonAbility.Guts, PokemonAbility.BigPecks, 3210800, 4230101, 9400738, 5220002),
        ...
        //沒有Bear(PokemonItem.Minidungeon_Diamond, MobExp.FAST, PokemonAbility.SpeedBoost, PokemonAbility.Defeatist, 9300269, 9001012, 9300350, 7150002, 9300270, 5120500, 6130203, 7220000, 8210003, 9300215),
        ...
        //沒有Lorang(PokemonItem.Emerald_Crystal, MobExp.FAST, PokemonAbility.PoisonPoint, PokemonAbility.PoisonTouch, 3230102, 4230104, 5220000),
        ...
        //沒有Warrior(PokemonItem.Courage_Piece, MobExp.FAST, PokemonAbility.Normalize, PokemonAbility.ShadowTag, 9400100, 9400101, 9400102, 9400110, 9400111, 9001000, 8610005, 8610010, 8850000),
        //Extra A(45), B(47), C(50), leader A(62), leader B(64), boss(70), official(165), advanced (169), boss(170)
        //沒有Mage(PokemonItem.Wisdom_Piece, MobExp.FAST, PokemonAbility.Normalize, PokemonAbility.ShadowTag, 9400100, 9400101, 9400102, 9400110, 9400111, 9001001, 8610006, 8610011, 8850001),
        //Extra A(45), B(47), C(50), leader A(62), leader B(64), boss(70), ifrit(169)
        //沒有Mage_1(PokemonItem.Wisdom_Piece, MobExp.FAST, PokemonAbility.Normalize, PokemonAbility.ShadowTag, 9400100, 9400101, 9400102, 9400110, 9400111, 9001001, 8610015),
        //Extra A(45), B(47), C(50), leader A(62), leader B(64), boss(70), official(165), advanced (169), boss(170)
        //沒有Bowman(PokemonItem.Accuracy_Piece, MobExp.FAST, PokemonAbility.Normalize, PokemonAbility.ShadowTag, 9400100, 9400101, 9400102, 9400110, 9400111, 9001002, 8610007, 8610012, 8850002),
        //Extra A(45), B(47), C(50), leader A(62), leader B(64), boss(70), official(165), advanced (169), boss(170)
        //沒有Rogue(PokemonItem.Dexterity_Piece, MobExp.FAST, PokemonAbility.Normalize, PokemonAbility.ShadowTag, 9400100, 9400101, 9400102, 9400110, 9400111, 9001003, 8610008, 8610013, 8850003),
        ...
        //Extra A(45), B(47), C(50), leader A(62), leader B(64), boss(70), official(165), advanced (169), boss(170)
        //沒有Pirate(PokemonItem.Freedom_Piece, MobExp.FAST, PokemonAbility.Normalize, PokemonAbility.ShadowTag, 9400100, 9400101, 9400102, 9400110, 9400111, 9001004, 8610009, 8610014, 8850004),
        ...
        //沒有Dummy_Strong(PokemonItem.Black_Diamond, MobExp.ERRATIC, PokemonAbility.Forewarn, PokemonAbility.Frisk, 9400539, 5120503, 5120504, 5090001),
        //straw(50), wooden(51), master(84)
        //沒有Dummy(PokemonItem.Black_Diamond, MobExp.ERRATIC, PokemonAbility.Forewarn, PokemonAbility.Frisk, 9001020, 9001021, 5090001),
        ...
        //沒有Zombie(PokemonItem.Black_Diamond, MobExp.SLOW, PokemonAbility.ToxicBoost, PokemonAbility.PoisonTouch, 9001027, 5130108, 6090000),
        //snow witch(58), black witch(120)
        //沒有Black_Witch(PokemonItem.Black_Diamond, MobExp.FAST, PokemonAbility.Intimidate, PokemonAbility.IronBarbs, 6090001, 9001010),
        //hodori(58), hogul(60)
        ...
        //沒有Frankenroid(PokemonItem.Black_Diamond, MobExp.STANDARD, PokemonAbility.Regenerator, PokemonAbility.Immunity, 9300154, 9300151, 9300152),
        ...
        //沒有Rumo(PokemonItem.Black_Diamond, MobExp.FAST, PokemonAbility.SapSipper, PokemonAbility.Overgrow, 3110302, 3110303, 6090004),
        ...
        //沒有Mutae(PokemonItem.Black_Diamond, MobExp.FAST, PokemonAbility.Multiscale, PokemonAbility.MagicGuard, 4110300, 4110301, 4110302, 5110300, 8220002),
        ...
        //沒有Roi(PokemonItem.Black_Diamond, MobExp.STANDARD, PokemonAbility.Regenerator, PokemonAbility.Immunity, 5110301, 5110302, 7110300, 8105003, 8090000),
    ...
    public enum PokemonItem implements PItem {
        ...
        Basic_Ball(3992017, 1.0), //紅色球 - 可以裝飾聖誕樹的裝飾品
        Great_Ball(3992018, 1.5), //藍色球 - 可以裝飾聖誕樹的裝飾品
        Ultra_Ball(3992019, 2.0), //黃色球 - 可以裝飾聖誕樹的裝飾品
        Yellow_Crystal(4001268, 2.0), //金色氪結晶體 - 含有宇宙的神秘氣息的金色氪結晶體
        Blue_Crystal(4001269, 2.0), //綠色氪結晶體 - 含有宇宙的神秘氣息的金色氪結晶體
        //Black_Diamond(4001469, 2.0),
        //Emerald_Crystal(4001468, 2.0),
        Saint_Stone(4020012, 1.0), //被封印的聖者之石 - 被封印的聖者之石
        //Minidungeon_Crystal(4001391, 1.0),
        Ice_Pick(4310007, 2.0), //冰撥片 - 用於吉他演奏的清涼的紫色撥片。交給彪魯，可以購買特殊的物品
        //Minidungeon_Diamond(4001392, 0.5),
        Bright_Feather(3994193, 1.0), //發光的羽毛 - 發出耀眼金光的羽毛，但不知是什麼鳥的羽毛。把它交給楓之谷運營員吧
        Gold_Pick(4310001, 0.5), //冰撥片 - 在外演出的彪魯回來後，可以和他交換的清涼的紫色吉他撥片
        Coin(4310002, 1.0), //國慶紀念銀幣 - 為慶祝國慶節而發行的銀幣。只在紀念期間流通，有著豐富用途
        Corrupted(4001237, 3.0), //輕微污染的石頭 - 有輕微的黑魔法師的氣息滲透其中
        More_Corrupted(4001238, 2.0), //污染的石頭 - 有黑魔法師的氣息滲透其中
        Most_Corrupted(4001239, 1.0), //強烈污染的石頭 - 有強烈的黑魔法師的氣息滲透其中
        Corrupted_Item(4001240, 2.0), //污染物質 - 因黑魔法師的氣息而變質的石頭
        Ancient_Relic(4001302, 2.0), //珍貴的遺物 - 看上去很珍貴的遺物
        Heart_of_Heart(4001244, 2.0), //愛心 - 獻給對方的愛心
        Phoenix_Egg(4001113, 1.0), //火鳳凰的卵 - 傳說中火鳳凰的卵
        Freezer_Egg(4001114, 1.0), //冰鳳凰的卵 - 傳說中冰鳳凰的卵
        Black_Hole(4001190, 0.5), //黑暗魔球 - 有種暗流隱藏在裡面的黑色珠子
        Maple_Marble(4031456, 0.5), //楓葉珠 - 透明的楓葉珠子
        Rainbow_Leaf(4032733, 0.5), //彩虹楓葉 - 散發著彩虹光芒的楓葉.搜集拿給運營員能獲得獎勵
        ...
        Intelligence_Document(4001192, 2.0), //碟報文件 - 有關頭目M和組隊任務怪物之間關係的碟報文件
        //Water_Bottle(4001195, 2.0),
        Dragon_Heart(4031449, 1.0), //飛龍的心臟 - 在飛龍體內的發光的心臟，凝聚著飛龍的能量，看似寶石
        Griffey_Wind(4031457, 1.0), //天鷹的輕柔暖風 - 天鷹的輕柔暖風舞動產生柔柔的風
        Deathly_Fear(4031448, 0.5), //死亡之火 - 從死亡的黑暗裡拿出來的死亡之火
        Summoning_Frame(4031451, 1.0), //召喚物的骨架 - 製作召喚物的基本骨架
        Magical_Array(4031453, 0.5), //方塊陣 - 封印黑色的靈魂並且有治癒的能力
        Life_Root(4031461, 1.0), //生命的根源 - 在生命洞穴裡生長的植物根
        Black_Tornado(4031458, 1.0), //黑甲凶靈的黑色旋風 - 黑甲凶靈魔法產生的黑色旋風
        Perfect_Pitch(4310000, 1.0), //絕對音感 - 彪魯正在急切尋找的擁有絕對音感的音標。10月31日前，在自由市場或弓箭手村的彪魯那裡可以交換到稀有道具
        Cold_Heart(4031460, 1.0), //冰冷的狼人心臟 - 狼人冰冷的心臟
        Ventilation(4031462, 2.0), //換氣機 - 地球防禦本部工程師卡伊製造的換氣機
        Old_Glove(4031465, 1.0), //赫麗娜的舊手套 - 是很久以前赫麗娜轉交給巫師的舊手套，雖然以年久但是還能看到它主人的老練
        Pocket_Watch(4001393, 1.0), //時間旅行者的懷表 - 證明有權使用塔拉森林裡的時間之門的物品。雖然長得和普通懷表一樣，但懷表背後刻著一行小字「時間是金」。
        Melted_Chocolate(3994199, 1.0), //石化龍珠 - 搜集9個石化龍珠到NPC運營員，能隨機獲得1個龍珠
        Whirlwind(4031459, 1.0); //幻魔精靈詛咒的龍捲風 - 以幻魔精靈的詛咒產生的龍捲風
        public final int id;
        public final double catchChance;
