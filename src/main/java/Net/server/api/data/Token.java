...
/**
 * Class to hold information about responses from the Lumiere OAuth Net.server.
 *
 * @author Tyler
 */
public class Token {
    ...
    /**
     * The refresh token is sent to the API to get a new Net.auth token before the current one expires.
     *
