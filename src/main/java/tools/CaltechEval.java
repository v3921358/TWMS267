...
public final class CaltechEval {

    private final String expression;
    private String[] Operators;
    private int[] OperatorsArgs;
    private boolean[] OperatorsLeftRight;
    private int[] OperatorsPrecedence;
...
//        Double D = new Double(0);
    ...
    private Vector<String> reduceTokens(Vector<String> tokens) {
//        Double D = new Double(0);
