...
public class OutputHeader {
    ...
    public static void main(String[] args) {
        boolean decimal;
        String recvopsName = "HeaderData\\包頭InHeader.properties";
        String sendopsName = "HeaderData\\包頭OutHeader.properties";
        try {
        ...
        try {
            ...
            Logger.getLogger(OutputHeader.class.getName()).log(Level.SEVERE, null, ex);
